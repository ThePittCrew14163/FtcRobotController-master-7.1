 ...
 */
@Autonomous(name="2X RED Duck side", group = "pick up alliance partner's preload")
public class DuckSideAutoRed2X extends DuckSideAutoRed {
    @Override
