...
public class WarehouseSideAutoBlue extends FreightFrenzy_BaseAutoSetup {
    ...
    public void runRobotAuto() {
        ...
        if (this.tse_position == TSE_Position.LEFT) { // bottom tray
            ...
            robot.odStrafe(0, 1, 68, 12, 4, 800, 0.03, false);
            ...
            robot.odStrafe(-28, 1, 65, 14, 4, 1200, 0.025, false);
            robot.odStrafe(-28, 0.4, 67, 25, 2, 1500);
            ...
            robot.motorTurnNoReset(0.6, (int) robot.ARM_TURNSTILE_CLICKS_PER_DEG * -157, robot.armTurnstile);
    ...
    public void AfterScorePreload() {
        ...
        robot.odTurn(90, 1, 800, 0.015, false);
        if (this.tse_position == TSE_Position.RIGHT) {
            robot.motorTurnNoReset(0.6, 0, robot.armTurnstile);
        }
    }
    public void DoCycles() {
        robot.odStrafe(90, 1, 70, 4, 3, 1000, 0.02, false);
        robot.odStrafe(90, 1, 70, 0, 3, 300, 0.02, false);
        ...
        while (System.currentTimeMillis() - startTimeInMs < 21200) {
            ...
            robot.intake.setPower(robot.INTAKE_ON_POWER);
            robot.odStrafe(92, 1, 45-c, 0, 3, 800, 0.025, false);
            ...
            // score freight
            robot.motorTurnNoReset(1, (int) (robot.ARM_TURNSTILE_CLICKS_PER_DEG * -(165+c)), robot.armTurnstile);
            ...
            robot.intakeFlap.setPosition(1);
            robot.odStrafe(140, 1, 72, 14, 4, 1000, 0.025, false);
        ...
        // park
        robot.intake.setPower(robot.INTAKE_ON_POWER);
        robot.odStrafe(90, 1, 40, 0, 6, 700, 0.025, false);
        robot.odStrafe(90, 0.5, 35, 3, 3, 800, 0.025, false);
